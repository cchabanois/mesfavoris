...
public class StatusHelper {
	private static PluginStatusManager pluginStatusManager = new PluginStatusManager(BookmarksPlugin.PLUGIN_ID);
	...
	public static void handleStatus(int statusSeverity, String statusMessage,
			Throwable statusThrowable, int style) {
		pluginStatusManager.handleStatus(statusSeverity, statusMessage, statusThrowable, style);
	}

	public static void handleStatusOnce(int statusSeverity, String statusMessage,
