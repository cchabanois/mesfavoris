 ...
 * </p>
 *
 * Modifications : Unmodified version except class made non-final and some fields made protected
 *
 * @since 1.11
 * @author Yaniv Inbar
 */
public class LocalServerReceiver implements VerificationCodeReceiver {
  ...
  protected final Condition gotAuthorizationResponse = lock.newCondition();
