...
public class OverlayIconImageDescriptor extends CompositeImageDescriptor {
	...
	public OverlayIconImageDescriptor(ImageDescriptor base, ImageDescriptor[] overlays, int width, int height) {
		this(base, new ImageDescriptor[][] { { overlays[0] }, { overlays[1] }, { overlays[2] } },
				new Point(width, height));
	}

	public OverlayIconImageDescriptor(ImageDescriptor base, ImageDescriptor[][] overlays, Point size) {
		fBase = base;
		fOverlays = overlays;
		fSize = size;
	}
