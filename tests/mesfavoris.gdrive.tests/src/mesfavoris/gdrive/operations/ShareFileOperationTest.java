...
public class ShareFileOperationTest {
	...
	public void testShareFile() throws Exception {
		...
		// Then
		byte[] contentsAsBytes = downloadFile(gdriveConnectionUser2, file.getId());
	...
	private byte[] downloadFile(GDriveConnectionRule driveConnection, String fileId) throws IOException {
		DownloadFileOperation downloadFileOperation = new DownloadFileOperation(driveConnection.getDrive());
